"""
Django settings for habb project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'habb.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Vladimir Myshkouski""", 'vladimirmyshkovski@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///habb'),
}
...
SOCIALACCOUNT_ADAPTER = 'habb.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['habb.taskapp.celery.CeleryConfig']
